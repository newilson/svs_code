...
options = optimset(oldoptions, 'TolFun', 1e-10,'TolX', 1e-10,'MaxFunEval',20000*10,'MaxIter', 15, 'Display','iter' );
...
diff = spec_mask .* abs(real(spec1-spec));
