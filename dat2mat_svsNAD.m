function [ws, nws, ppm] = dat2mat_svsNAD(ws_dat,nws_dat,pars)
%
...
pars.eccopt = 0; % use eddy current correction to frequency correct signal from large voxels

if ~isfield(pars,'lb'), pars.lb = 3; end
...
[ws, nws] = eddyCurrentCorrection(nws,ws,pars.eccopt);
...
addlb = 0; % additional line broadening to locate peaks
hzshift = 0;
